...
public class GameState implements Serializable {
     ...
     * @throws BadDopoCream_Exceptions.SaveGameException si falla el guardado
     */
    public static boolean saveGame(BadDopoCream game, String playerColor, String gameMode, String saveName) 
            throws BadDopoCream_Exceptions.SaveGameException {
        try {
            ...
            for (Fruit fruit : currentLevel.getFruits()) {
                state.fruits.add(new SerializableFruit(fruit));
            }
            
            // Guardar enemigos
            for (Enemy enemy : currentLevel.getEnemies()) {
                state.enemies.add(new SerializableEnemy(enemy));
            }
            ...
            throw new BadDopoCream_Exceptions.SaveGameException(saveName, e);
        }
    }
    ...
    public static boolean saveGameSafe(BadDopoCream game, String playerColor, String gameMode, String saveName) {
        try {
            ...
            return true;
        } catch (BadDopoCream_Exceptions.SaveGameException e) {
     ...
     * @throws BadDopoCream_Exceptions.LoadGameException si falla la carga
     * @throws BadDopoCream_Exceptions.CorruptedSaveFileException si el archivo está corrupto
     */
    public static GameState loadGame(String saveName) 
            throws BadDopoCream_Exceptions.LoadGameException, 
                   BadDopoCream_Exceptions.CorruptedSaveFileException {
        try {
            String fileName = SAVE_DIRECTORY + "/" + saveName + SAVE_EXTENSION;
            ...
            throw new BadDopoCream_Exceptions.CorruptedSaveFileException(saveName, e);
        } catch (IOException e) {
            throw new BadDopoCream_Exceptions.LoadGameException(saveName, e);
        }
    }
    ...
    public static GameState loadGameSafe(String saveName) {
        ...
        } catch (BadDopoCream_Exceptions.CorruptedSaveFileException e) {
            System.err.println("Archivo de guardado corrupto: " + e.getMessage());
            return null;
        } catch (BadDopoCream_Exceptions.LoadGameException e) {
