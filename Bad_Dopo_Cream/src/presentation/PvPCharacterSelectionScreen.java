...
public class PvPCharacterSelectionScreen extends JPanel {
    ...
    private void createComponents() {
        ...
        ButtonImageConfigurator.configureImageButton(pinkIceCreamButton, 
            "resources\\Recusos nuevos\\Fresa.png", 
            "resources\\Personajes\\Fresa\\Victoria animation.gif", 60, 80);
        ButtonImageConfigurator.configureImageButton(vanillaIceCreamButton, 
            "resources\\Recusos nuevos\\Vainilla.png", 
            "resources\\Personajes\\Vainilla\\Victoria animation.gif", 60, 80);
        ButtonImageConfigurator.configureImageButton(chocolateIceCreamButton, 
            "resources\\Recusos nuevos\\Cocholate.png", 
            "resources\\Personajes\\Chocolate\\Victoria animation.gif", 60, 80);
        ...
        ButtonImageConfigurator.configureImageButton(macetaButton, 
            "resources\\Recusos nuevos\\Maceta enemigo.png", 
            "resources\\Enemigos\\Maceta\\Ataque animation.gif", 80, 80);
        ButtonImageConfigurator.configureImageButton(trollButton, 
            "resources\\Recusos nuevos\\Troll.png", 
            "resources\\Troll\\Caminar Abajo animation.gif", 80, 70);
        ButtonImageConfigurator.configureImageButton(calamarButton, 
            "resources\\Recusos nuevos\\Calamar Amarillo.png", 
            "resources\\Calamar Amarillo\\Caminando Abajo animation.gif", 60, 80);
        // Botón de volver
