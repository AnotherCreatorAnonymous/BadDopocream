...
public class SaveLoadScreen extends JPanel {
    ...
    private JPanel createSaveItem(String saveName) {
        ...
        GameState state = GameState.loadGameSafe(saveName);
    ...
    private void saveGame() {
        ...
        boolean success = GameState.saveGameSafe(game, playerColor, gameMode, saveName);
    ...
    private void deleteSave(String saveName) {
        ...
        if (result == JOptionPane.YES_OPTION) {
            boolean success = GameState.deleteSave(saveName);
