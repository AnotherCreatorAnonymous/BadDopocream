...
public class MenuPanel extends JPanel{
    ...
    private void loadBackgroundImage(String imagePath){
        try{
            ...
            domain.BadDopoCream_Exceptions.ImageLoadException ex = 
                new domain.BadDopoCream_Exceptions.ImageLoadException(imagePath, e);
            System.err.println("⚠️ " + ex.getMessage());
            setBackground(BACKGROUND_FALLBACK);
        } catch (Exception e){
            domain.BadDopoCream_Exceptions.UIComponentInitializationException ex = 
                new domain.BadDopoCream_Exceptions.UIComponentInitializationException(
                    "MenuPanel - Fondo", e);
            System.err.println("⚠️ " + ex.getMessage());
            setBackground(BACKGROUND_FALLBACK);
        }
    ...
    private void createButtons(){
        ...
        ButtonImageConfigurator.configureImageButton(playButton, 
            "resources\\Recusos nuevos\\Botones jugar claro.png", 
            "resources\\Recusos nuevos\\Botones jugar oscuro.png");

        optionsButton = createMenuButton("");
        ButtonImageConfigurator.configureImageButton(optionsButton, 
            "resources\\Recusos nuevos\\Botones opciones claro.png", 
            "resources\\Recusos nuevos\\Botones opciones oscuro.png");
        gbc.gridy = 2;
        gbc.insets = new Insets(15, 0, 15, 0);
        ...
        ButtonImageConfigurator.configureImageButton(creditsButton, 
            "resources\\Recusos nuevos\\Botones creditos claro.png", 
            "resources\\Recusos nuevos\\Botones creditos oscuro.png");
        gbc.gridy = 3;
        ...
        ButtonImageConfigurator.configureImageButton(exitButton, 
            "resources\\Recusos nuevos\\Boton salir.png", 
            "resources\\Recusos nuevos\\Boton salir.png");
        gbc.gridy = 4;
        add(exitButton, gbc);
    }
