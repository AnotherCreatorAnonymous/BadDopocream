...
public class LevelSelectionScreen extends JPanel {
    ...
    private static final int MAX_LEVELS = 10; // Cantidad máxima de niveles
    private static final int UNLOCKED_LEVELS = 5; // Niveles desbloqueados inicialmente
    ...
    private void loadBackgroundImage(String imagePath) {
        try {
            backgroundImage = javax.imageio.ImageIO.read(new java.io.File(imagePath));
