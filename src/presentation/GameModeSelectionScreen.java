...
import domain.BadDopoCream_Exceptions.ImageLoadException;
import domain.BadDopoCream_Exceptions.UIComponentInitializationException;
import java.awt.*;
import java.io.File;
    ...
    private void loadBackgroundImage(String imagePath) {
        try {
            ...
            ImageLoadException ex = 
                new ImageLoadException(imagePath, e);
            System.err.println("⚠️ " + ex.getMessage());
        } catch (Exception e) {
            UIComponentInitializationException ex = 
                new UIComponentInitializationException(
