...
import domain.BadDopoCream_Exceptions;
import java.awt.*;
import java.net.URL;
import javax.swing.*;
...
public abstract class BaseImageConfigurator {
        ...
        try {
            ...
            if (resourceUrl != null) {
                ...
                if (fallbackImg == null) {
                    ...
                    throw new BadDopoCream_Exceptions.MissingImageException(resourcePath);
                }
                return fallbackImg;
            }
        } catch (BadDopoCream_Exceptions.ImageLoadException e) {
            ...
            BadDopoCream_Exceptions.ImageLoadException ex = 
                new BadDopoCream_Exceptions.ImageLoadException(resourcePath, e);
    ...
    private static Image loadImageFromFile(String filePath) {
        try {
            ...
            BadDopoCream_Exceptions.ImageLoadException ex = 
                new BadDopoCream_Exceptions.ImageLoadException(filePath, e);
            System.err.println("⚠️  " + ex.getMessage());
            return null;
        }
    }
    ...
    protected static void waitForAllImages(String resourceType) {
        try {
            ...
            BadDopoCream_Exceptions.GameInterruptedException ex = 
                new BadDopoCream_Exceptions.GameInterruptedException(
